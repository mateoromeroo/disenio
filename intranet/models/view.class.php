        ...
        // Sección 3 - Configuración de estructura y contenido de tabla
            ...
            foreach($result as $col){
                ...
                for($i=0;$i<count($table);$i++){
                    ...
                    $urlNoImage = $table['col-'.$i]['body']['data']['url-no-image'];
                    ...
                    switch($typeData){           
                        case 'text'://Tipo texto
                            for($r=0;$r<$countArrRow;$r++){
                                ...
                                $htmlTd2 .= $iconConect.'<div style="'.$tdStyle.'">'.$col[$table['col-'.$i]['body']['data']['row'][$r]].'</div>';     
                            }             
                        break;
                        ...
                        case 'image': //Tipo imagen
                            for($r=0;$r<$countArrRow;$r++){
                                $arrModal = explode('.',$col[$table['col-'.$i]['body']['data']['row'][$r]]);
                                $idModal = $arrModal[0];

                                if($col[$table['col-'.$i]['body']['data']['row'][$r]]!=''){
                                    ...
                                    if($urlNoImage!=''){
                                        $htmlTd2 .= '<button disabled><img style="'.$tdStyle.'" src="'.$urlNoImage.'"></button>';
                                    }else{
                                        $htmlTd2 .= '';
                                    }
                                }
                        ...
                        case 'color': // Tipo paleta de colores
                            for($r=0;$r<$countArrRow;$r++){
                                if($r==0){
                                    $iconConect='';
                                }else{
                                ...
                                $htmlTd2 .= $iconConect.'<div style="'.$tdStyle.'background:'.$col[$table['col-'.$i]['body']['data']['row'][$r]].';"></div><br><p><b>'.$col[$table['col-'.$i]['body']['data']['row'][$r]].'</b></p>';     
                            }
                        break;
                    }
